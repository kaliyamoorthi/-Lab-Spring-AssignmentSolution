package com.greatLearning.Kl.libraryManagement.controller;
...
import com.greatLearning.Kl.libraryManagement.service.KlBookService;




@Controller
@RequestMapping("/Klbooks")
public class KlBooksController {

	@Autowired
	private KlBookService bookService;
	...
	public String listBooks(Model theModel) {
		...
		// get Books from db
		List<KlBook> theBooks = bookService.findAll();
	...
	public String showFormForUpdate(@RequestParam("bookId") int theId,
		...
		KlBook theBook = bookService.findById(theId);
	...
	public String saveBook(@RequestParam("id") int id,
		...
		if(id!=0)
		{
			...
			theBook=new KlBook(name, category, author);
		// save the Book
