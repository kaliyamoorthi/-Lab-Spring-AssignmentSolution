...
import com.greatLearning.Kl.libraryManagement.service.KlUserDetailsServiceImpl;


@Configuration
public class KlWebSecurityConfig extends WebSecurityConfigurerAdapter{

	 @Bean
	    public UserDetailsService userDetailsService() {
	        return new KlUserDetailsServiceImpl();
	    }
